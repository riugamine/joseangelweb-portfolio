    ...
    >
      ...
      <div className="space-y-6 p-6">
        <span className="inline-block px-4 py-2 bg-[rgba(59,130,246,0.2)] text-blue-400 rounded-full text-sm font-medium backdrop-blur-sm border border-blue-500/20">
          {t('hero.digitalSolutions')}
        </span>
        
        <motion.h1 
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight"
        >
          <span className="inline-block mb-1">{t('hero.letsCreate')}</span>
          <br className="hidden sm:block" />
          <span className="inline-block mb-1">{t('hero.business')}</span>
          <br className="hidden sm:block" />
          <span className="text-blue-400 inline-block">{t('hero.different')}</span>
        </motion.h1>
